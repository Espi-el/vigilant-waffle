...
from memory_api import DiffMemory, create_memory_interface, quick_search

# Example repository and user setup
REPO_PATH = "./assistant/users/anna"  # Update this path
USER_ID = "anna"  # Update this to your user ID
...
def basic_usage_example():
    ...
    memory = DiffMemory(REPO_PATH, USER_ID, OPENAI_API_KEY)
...
def error_handling_example():
    ...
    try:
        ...
        memory = create_memory_interface(REPO_PATH, USER_ID, openai_api_key="")
...
def integration_example():
    ...
    if OPENAI_API_KEY and Path(REPO_PATH).exists():
...
if __name__ == "__main__":
    ...
    if not Path(REPO_PATH).exists() or not OPENAI_API_KEY:
        print("Please update REPO_PATH and set OPENAI_API_KEY environment variable")
